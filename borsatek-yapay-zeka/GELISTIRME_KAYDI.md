...
|-------|-----|--------|------|
| 2026-05-06 | düzeltme | `class-rewriter.php`, `class-seo-engine.php`, `v2.0.2` | **Çelişen talimat giderildi:** Önceki prompt çok “aynını koru”ya kaydığı için çıktı kaynağa yapışık kalıyordu. Şimdi açık **editoryel yeniden yazım** (ters piramit, farklı cümle yapısı, kopyala-yapıştır yasak) + sadakat birlikte isteniyor. Kaynakta olmayan psikoloji/nedensellik köprüleri yasak. **CENTCOM, WTI, NASDAQ** vb. kısaltmalar normalleştirmede korunuyor (noktalama soyarak eşleme). |
